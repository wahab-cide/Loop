...
export async function POST(request: Request) {
  try {
    ...
    console.log('Parsed parameters:', { destinationAddress, destinationLat, destinationLng, userLat, userLng, radiusKm });
    ...
    console.log('Database query completed, found', rides.length, 'rides');
    ...
    console.log('Transformed rides count:', transformedRides.length);
